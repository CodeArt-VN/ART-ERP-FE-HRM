...
@Component({
	...
	templateUrl: 'timesheet-record.page.html',
	styleUrls: ['timesheet-record.page.scss'],
	standalone: false,
})
export class TimesheetRecordPage extends PageBase {
	statusList = [];
	timesheetList = [];
	itemsState: any = [];
	itemsView: any = [];
	...
	navTo(i) {
		...
		// 	},
		// };
		this.nav('/timesheet-record/' +  i.IDParent + '/' + i.IDTimesheet, 'forward');
	}
